...
void Calibrator::run(cv::VideoCapture& videoCaptureObjectIn, unsigned int& imageTextureOut)
{
  ...
  cv::putText(_frameCopy, "Press 'C' to add current frame. 'ESC' to finish and calibrate",
